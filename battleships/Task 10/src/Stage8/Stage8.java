...
public class Stage8 {
	...
	public static void main(String[] args) {
		...
		Point AIShot = null;
		ArrayList<Point> AIShotsToFireAt = new ArrayList<Point>();
		while(totalnumberofsquaresingrid>0){
			...
			if(AIShotsToFireAt.size()==0){
				...
				System.out.println("AI shooting at: " + player2y+"," + player2x+ "...");
			}else{
				...
				System.out.println("AI Should be shooting at: " + AIShotsToFireAt.get(randomIndex));
				...
				System.out.println("AI shooting at: " + AIShotsToFireAt.get(randomIndex).getY()+"," + AIShotsToFireAt.get(randomIndex).getX()+ "...");
			}
			...
			if(Player2shotResult.equalsIgnoreCase("HIT!!!! BOOM!!!")){
				...
				System.out.println("AI hit: " + AIShot.getY() + " "+ AIShot.getX());
				System.out.println("Will now aim at the following areas: ");
				for(Point x : AIShotsToFireAt){
					System.out.println(x);
				}
			}
